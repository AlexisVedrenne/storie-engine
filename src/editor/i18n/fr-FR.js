...
export default {
  ...
  editorPage: {
    ...
    tabReactions:
      'Réactions — Events (actions du joueur) et Automatisations (conditions), hors timeline',
    tabInteractions:
    ...
    reactionsSubAutomations: 'Automatisations',
    dataSubFlags: 'Flags',
    ...
    automationsEmptyState: 'Sélectionne ou crée une automatisation à gauche.',
  ...
  automationForm: {
    ...
    actionTitle: 'Action',
    actionHelp: 'Rien ne se passe tant que la condition ci-dessus n’est pas vraie.',
    repeatTitle: 'Répétition',
    repeatHelp:
      'Combien de fois cette automatisation peut se déclencher pendant la partie (à chaque fois que la condition redevient vraie après être repassée fausse).',
    repeatOnce: 'Une fois',
    repeatCount: 'Un nombre de fois',
    repeatUnlimited: 'Illimité',
    repeatCountLabel: 'Nombre de fois',
  },
  ...
  customAppEditor: {
    ...
    themeSurface: 'Surface (cartes, onglets...)',
    themeText: 'Texte',
    themePrimary: 'Primaire',
    themeSecondary: 'Secondaire',
    themeDanger: 'Alerte',
    themeFontLabel: 'Police',
    themeFontSans: 'Sans-serif',
    themeFontSerif: 'Serif',
    themeFontMono: 'Monospace',
    themeFontRounded: 'Arrondie',
    themeRadiusLabel: 'Arrondi',
    themeRadiusSharp: 'Anguleux',
    themeRadiusNormal: 'Normal',
    themeRadiusRound: 'Arrondi',
    themeSpacingLabel: 'Espacement',
    themeSpacingTight: 'Compact',
    themeSpacingNormal: 'Normal',
    themeSpacingLoose: 'Aéré',
  },
  ...
  blockBuilder: {
    ...
    emptyRootDetail:
      'Clique (ou glisse) un bloc de la palette ci-dessus pour l’ajouter. Sélectionne-le ensuite pour le configurer à droite — le résultat s’affiche en direct sur le téléphone.',
    paletteBtnHint: 'Clique pour ajouter, ou glisse-le où tu veux',
    duplicate: 'Dupliquer',
  },
  ...
  blockProps: {
    ...
    actionOnFailToastLabel: 'Message si la condition échoue (optionnel)',
    actionOnFailToastHint: 'Vide = rien ne s’affiche, l’action est juste silencieusement annulée.',
    ...
    mapPoiDynamicPositionLabel: 'Position dynamique (liée à une instance)',
    mapPoiDynamicPositionHint:
      'Le point suit en direct les champs X/Y d’une instance de schéma au lieu d’une position fixe.',
    mapPoiXFieldLabel: 'Champ X (nombre)',
    mapPoiYFieldLabel: 'Champ Y (nombre)',
    mapPoiContentTitle: 'Contenu du point (blocs, optionnel)',
    mapPoiContentHelp:
      'Remplace l’icône/le nom par une mini-carte contenant tes propres blocs (texte, avatar, badge…). Vide = affichage classique icône + nom.',
    mapPoiSizeLabel: 'Taille (icône/image)',
    mapPoiImageLabel: 'Image (remplace l’icône)',
    mapPoiLabelSizeLabel: 'Taille du texte',
    mapPoiLabelColorLabel: 'Couleur du texte',
    mapPoiPickButton: 'Positionner sur la carte',
    mapPoiPickCancel: 'Clique sur la carte pour placer le point (clic ici pour annuler)',
    ...
    alignCenter: 'Centre',
    alignRight: 'Droite',
    layoutJustifyLabel: 'Alignement horizontal',
    layoutAlignLabel: 'Alignement vertical',
    justifyStart: 'Début',
    justifyCenter: 'Centre',
    justifyEnd: 'Fin',
    justifyBetween: 'Espacé (entre)',
    justifyAround: 'Espacé (autour)',
    alignStretch: 'Étiré (défaut)',
    alignItemsStart: 'Début',
    alignItemsCenter: 'Centre',
    alignItemsEnd: 'Fin',
    overlayOffsetXLabel: 'Décalage X',
    overlayOffsetYLabel: 'Décalage Y',
    cardActionHelp: 'Rien ne se passe au tap sur cette carte.',
    buttonFlatLabel: 'Style plat (sans fond, texte coloré)',
    sizeSmall: 'Petit',
    sizeNormal: 'Normal',
    sizeLarge: 'Grand',
  },
  ...
  requiresBuilder: {
    ...
    entitiesTitle: 'Schémas',
    entitiesHelp:
      'Vérifie le champ d’une instance de schéma (voir Données > Schémas) — même principe qu’une condition de stat, sur une donnée à plusieurs champs plutôt qu’un flag.',
    noEntityCondition: 'Aucune condition de schéma.',
    schemaLabel: 'Schéma',
    entityIdLabel: 'Instance (id, ou * pour la seule/première)',
    fieldLabel: 'Champ',
    addEntityCondition: 'Ajouter une condition de schéma',
    modeBool: 'vrai / faux',
  ...
  triggers: {
    ...
    'automation.fired': {
      ...
      fields: { automationId: { label: 'Automatisation' } },
    },
    'interaction.won': {
