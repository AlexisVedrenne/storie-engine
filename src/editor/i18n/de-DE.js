...
export default {
  ...
  editorPage: {
    ...
    tabChapters: 'Kapitel',
    tabReactions:
      'Reaktionen — Events (Spieleraktionen) und Automatisierungen (Bedingungen), außerhalb der Timeline',
    ...
    reactionsSubAutomations: 'Automatisierungen',
    dataSubFlags: 'Flags',
  ...
  customAppEditor: {
    ...
    themeSurface: 'Fläche (Karten, Tabs...)',
    themeText: 'Text',
    themePrimary: 'Primär',
    themeSecondary: 'Sekundär',
    themeDanger: 'Warnung',
    themeFontLabel: 'Schriftart',
    themeFontSans: 'Serifenlos',
    themeFontSerif: 'Serif',
    themeFontMono: 'Monospace',
    themeFontRounded: 'Abgerundet',
    themeRadiusLabel: 'Eckenradius',
    themeRadiusSharp: 'Eckig',
    themeRadiusNormal: 'Normal',
    themeRadiusRound: 'Rund',
    themeSpacingLabel: 'Abstand',
    themeSpacingTight: 'Eng',
    themeSpacingNormal: 'Normal',
    themeSpacingLoose: 'Weit',
  },
  ...
  blockProps: {
    ...
    actionRequestInput: 'Eingabe anfordern',
    actionRequestInputHelp:
      'Öffnet eine kleine zentrierte Eingabeaufforderung mit einem einzigen Feld — schreibt direkt in ein Flag oder ein Entitätsfeld, ohne selbst ein Blatt bauen zu müssen.',
    actionTriggerEntry: 'Szene auslösen',
    actionTriggerEntryHelp:
      'Führt eine kleine skriptete Sequenz aus (Nachricht, Auswahl, Anruf...) — wie eine Reaktion im Ereignisse-Tab, nur durch Antippen statt durch einen Auslöser.',
    actionWait: 'Warten',
    actionWaitHelp: 'Legt eine Pause vor der nächsten Aktion einer Sequenz ein.',
    actionWaitMsLabel: 'Dauer',
    actionSequence: 'Sequenz',
    ...
    mapPoiDynamicPositionLabel: 'Dynamische Position (mit Instanz verknüpft)',
    mapPoiDynamicPositionHint:
      'Der Punkt folgt live den X/Y-Feldern einer Schema-Instanz statt einer festen Position.',
    mapPoiXFieldLabel: 'X-Feld (Zahl)',
    mapPoiYFieldLabel: 'Y-Feld (Zahl)',
    mapPoiContentTitle: 'Inhalt des Punkts (Blöcke, optional)',
    mapPoiContentHelp:
      'Ersetzt Symbol/Name durch eine Mini-Karte mit eigenen Blöcken (Text, Avatar, Badge…). Leer = klassische Symbol+Name-Anzeige.',
    mapPoiSizeLabel: 'Größe (Symbol/Bild)',
    mapPoiImageLabel: 'Bild (ersetzt das Symbol)',
    mapPoiLabelSizeLabel: 'Textgröße',
    mapPoiLabelColorLabel: 'Textfarbe',
    mapPoiPickButton: 'Auf der Karte platzieren',
    mapPoiPickCancel: 'Auf die Karte tippen, um den Punkt zu setzen (hier klicken zum Abbrechen)',
    ...
    alignCenter: 'Mitte',
    alignRight: 'Rechts',
    layoutJustifyLabel: 'Horizontale Ausrichtung',
    layoutAlignLabel: 'Vertikale Ausrichtung',
    justifyStart: 'Anfang',
    justifyCenter: 'Mitte',
    justifyEnd: 'Ende',
    justifyBetween: 'Verteilt (zwischen)',
    justifyAround: 'Verteilt (um)',
    alignStretch: 'Gestreckt (Standard)',
    alignItemsStart: 'Anfang',
    alignItemsCenter: 'Mitte',
    alignItemsEnd: 'Ende',
    overlayOffsetXLabel: 'X-Versatz',
    overlayOffsetYLabel: 'Y-Versatz',
    cardActionHelp: 'Beim Antippen dieser Karte passiert nichts.',
    buttonFlatLabel: 'Flacher Stil (ohne Füllung, farbiger Text)',
    sizeSmall: 'Klein',
    sizeNormal: 'Normal',
    sizeLarge: 'Groß',
  },
