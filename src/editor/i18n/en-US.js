...
export default {
  ...
  blockProps: {
    ...
    mapPoiDynamicPositionLabel: 'Dynamic position (linked to an instance)',
    mapPoiDynamicPositionHint:
      'The point follows an entity instance’s X/Y fields live, instead of a fixed position.',
    mapPoiXFieldLabel: 'X field (number)',
    mapPoiYFieldLabel: 'Y field (number)',
    mapPoiContentTitle: 'Point content (blocks, optional)',
    mapPoiContentHelp:
      'Replaces the icon/name with a mini-card containing your own blocks (text, avatar, badge…). Empty = classic icon + name display.',
    mapPoiSizeLabel: 'Size (icon/image)',
    mapPoiImageLabel: 'Image (replaces the icon)',
    mapPoiLabelSizeLabel: 'Text size',
    mapPoiLabelColorLabel: 'Text color',
    mapPoiPickButton: 'Place on the map',
    mapPoiPickCancel: 'Click the map to place the point (click here to cancel)',
    ...
    alignCenter: 'Center',
    alignRight: 'Right',
    layoutJustifyLabel: 'Horizontal alignment',
    layoutAlignLabel: 'Vertical alignment',
    justifyStart: 'Start',
    justifyCenter: 'Center',
    justifyEnd: 'End',
    justifyBetween: 'Space between',
    justifyAround: 'Space around',
    alignStretch: 'Stretch (default)',
    alignItemsStart: 'Start',
    alignItemsCenter: 'Center',
    alignItemsEnd: 'End',
    overlayOffsetXLabel: 'X offset',
    overlayOffsetYLabel: 'Y offset',
    cardActionHelp: 'Nothing happens when this card is tapped.',
    buttonFlatLabel: 'Flat style (no fill, colored text)',
    sizeSmall: 'Small',
    sizeNormal: 'Normal',
    sizeLarge: 'Large',
  },
